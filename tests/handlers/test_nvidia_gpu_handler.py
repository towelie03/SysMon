...
from backend.gpu_handler import GPU  # Adjust the import based on your directory structure
...
def mock_subprocess_success(monkeypatch):
    ...
    mock_output = "150.0\n120.5\n"
    monkeypatch.setattr("subprocess.check_output", lambda cmd: mock_output.encode("utf-8"))
